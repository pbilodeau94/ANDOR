export const programHighlights: Record<string, string[]> = {
  MOGAD: [
    ...
    'Leading METEROID, a clinical trial evaluating treatment strategies for MOGAD relapse prevention',
    'Participating in the rozanolixizumab trial for MOGAD, testing a novel FcRn antagonist',
  ...
  NMOSD: [
    ...
    'Comparative effectiveness studies and multi-center cohort analyses of rituximab, tocilizumab, and FDA-approved therapies in real-world settings',
  ...
  'Autoimmune Encephalitis': [
    ...
    'Characterization of seronegative encephalitis through a registry, identifying diagnostic biomarkers and treatment patterns',
  ],
  Neurosarcoidosis: [
  ...
  'EBV and MS': [
    ...
    'Demonstration that tenofovir prodrugs potently inhibit EBV lytic DNA replication, opening the door to antiviral MS therapies',
    'Establishing the EBV-celiac disease parallel as a framework for understanding molecular mimicry in MS',
  ],
  'Neuro-Rheumatology': [
...
export const whyThisMatters: Record<string, string> = {
  ...
  Neurosarcoidosis:
    'Neurosarcoidosis remains one of the most difficult neuroimmunological diagnoses to make and treat. There are no FDA-approved therapies, and most treatment decisions are based on limited evidence. Our research is uncovering the fundamental immune mechanisms driving nervous system sarcoidosis, working toward the first evidence-based treatment guidelines.',
  'CNS Vasculitis':
